...
* Within the information box on the pull request page, create a title that reflects the nature of the content added, as well as a reference to the issue number that was opened stating the need for this topic, such as 'Issue #39 - Added information about stand-alone architecture', entering any other relevant notes within the comment field.
